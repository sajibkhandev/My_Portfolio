...
export default function EventProject({src}) {
  return (
    <div>
         <div className='group/div w-[360px] h-[245px] bg-[#FAFDFF]  rounded-xl relative overflow-hidden drop-shadow-2xl'>
          ...
          <h6 className='absolute bottom-[38px] left-[55px] text-base text-black font-semibold font-robo '>Web Design</h6>
          <p className='absolute bottom-[18px] left-[55px] text-sm text-five font-normal font-robo'>Demo</p>
